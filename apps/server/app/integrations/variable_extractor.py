...
def extract_gmail_variables(trigger_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not variables:
        logger.info(
            "No Gmail variables extracted from trigger_data",
            extra={"trigger_data": trigger_data},
        )
...
def extract_google_drive_variables(trigger_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not variables:
        logger.info(
            "No Google Drive variables extracted from trigger_data",
            extra={"trigger_data": trigger_data},
        )
...
def extract_calendar_variables(trigger_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not variables:
        logger.info(
            "No Calendar variables extracted from trigger_data",
            extra={"trigger_data": trigger_data},
        )
...
def extract_github_variables(trigger_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not variables:
        logger.info(
            "No GitHub variables extracted from trigger_data",
            extra={"trigger_data": trigger_data},
        )
...
def extract_rss_variables(trigger_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if "matched_keywords" in trigger_data:
        ...
        if isinstance(matched_keywords, list):
            variables["rss.matched_keywords"] = ", ".join(
                str(kw) for kw in matched_keywords
            )
        else:
    ...
    if not variables:
        logger.info(
            "No RSS variables extracted from trigger_data",
            extra={"trigger_data": trigger_data},
        )
