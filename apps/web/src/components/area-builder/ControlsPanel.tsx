                            ...
                            {nodeConfig.serviceId === 'google_drive' && nodeConfig.actionId === 'file_in_folder' && (
                              <div>
                                ...
                                <Input
                                  ...
                                  onFocus={handleInputFocus}
                                />
                                <p className="text-xs text-gray-500 mt-1">ID of the Google Drive folder to monitor for new files.</p>
                              </div>
                            )}
                        ...
                        {nodeConfig.serviceId && (
                          <>
                            ...
                            {nodeConfig.serviceId === 'google_calendar' && nodeConfig.actionId === 'create_event' && (
                              <div className="space-y-3">
                                <div>
                                  <Label htmlFor="calendar_summary">Event Title *</Label>
                                  <Input
                                    id="calendar_summary"
                                    type="text"
                                    placeholder="Team Meeting"
                                    value={(nodeConfig as ActionNodeData).params?.summary as string || ''}
                                    onChange={(e) => {
                                      const currentParams = (nodeConfig as ActionNodeData).params || {};
                                      onNodeConfigChange(selectedNodeId, { ...nodeConfig, params: { ...currentParams, summary: e.target.value } } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Required: Title of the event</p>
                                </div>
                                <div>
                                  ...
                                  <Input
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Required: ISO 8601 format (YYYY-MM-DDTHH:MM:SS)</p>
                                </div>
                                <div>
                                  ...
                                  <Input
                                    ...
                                    type="text"
                                    placeholder="2024-12-25T11:00:00"
                                ...
                                <div>
                                  <Label htmlFor="calendar_location">Location</Label>
                                  <Input
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Optional: Event location</p>
                                </div>
                                <div>
                                  ...
                                  <textarea
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Optional: Event description (supports variables)</p>
                                </div>
                                <div>
                                  <Label htmlFor="calendar_attendees">Attendees</Label>
                                  <Input
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Optional: Comma-separated email addresses</p>
                                </div>
                              </div>
                            )}
                              ...
                              <div className="space-y-3">
                                <div>
                                  ...
                                  <Input
                                    ...
                                    type="text"
                                    placeholder="event_id_from_trigger"
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">{`Required: Use {{calendar.event_id}} from trigger`}</p>
                                </div>
                                <div>
                                  <Label htmlFor="calendar_update_summary">Event Title</Label>
                                  <Input
                                    id="calendar_update_summary"
                                    type="text"
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Optional: New title for the event</p>
                                </div>
                                <div>
                                  <Label htmlFor="calendar_update_start_time">Start Time</Label>
                                  <Input
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Optional: ISO 8601 format</p>
                                </div>
                                <div>
                                  <Label htmlFor="calendar_update_end_time">End Time</Label>
                                  <Input
                                ...
                                <div>
                                  <Label htmlFor="calendar_update_location">Location</Label>
                                  <Input
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Optional: New location</p>
                                </div>
                                <div>
                                  <Label htmlFor="calendar_update_description">Description</Label>
                                  <textarea
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Optional: New description</p>
                                </div>
                              </div>
                            )}
                            ...
                            {nodeConfig.serviceId === 'google_calendar' && nodeConfig.actionId === 'create_all_day_event' && (
                              <div className="space-y-3">
                                <div>
                                  <Label htmlFor="calendar_all_day_summary">Event Title *</Label>
                                  <Input
                                    id="calendar_all_day_summary"
                                    type="text"
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Required: Title of the all-day event</p>
                                </div>
                                <div>
                                  <Label htmlFor="calendar_start_date">Start Date *</Label>
                                  <Input
                                    id="calendar_start_date"
                                    type="text"
                                    placeholder="2024-12-25"
                                    value={(nodeConfig as ActionNodeData).params?.start_date as string || ''}
                                    onChange={(e) => {
                                      const currentParams = (nodeConfig as ActionNodeData).params || {};
                                      onNodeConfigChange(selectedNodeId, { ...nodeConfig, params: { ...currentParams, start_date: e.target.value } } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Required: Date in YYYY-MM-DD format</p>
                                </div>
                                <div>
                                  <Label htmlFor="calendar_end_date">End Date</Label>
                                  <Input
                                    id="calendar_end_date"
                                    type="text"
                                    placeholder="2024-12-26"
                                    value={(nodeConfig as ActionNodeData).params?.end_date as string || ''}
                                    onChange={(e) => {
                                      const currentParams = (nodeConfig as ActionNodeData).params || {};
                                      onNodeConfigChange(selectedNodeId, { ...nodeConfig, params: { ...currentParams, end_date: e.target.value } } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Optional: End date in YYYY-MM-DD format (defaults to start_date + 1 day)</p>
                                </div>
                                <div>
                                  <Label htmlFor="calendar_all_day_description">Description</Label>
                                  <textarea
                                    id="calendar_all_day_description"
                                    className="w-full p-2 border rounded mt-1 min-h-[80px]"
                                    placeholder="Event description"
                                    value={(nodeConfig as ActionNodeData).params?.description as string || ''}
                                    onChange={(e) => {
                            ...
                            {nodeConfig.serviceId === 'google_drive' && nodeConfig.actionId === 'upload_file' && (
                              <div className="space-y-3">
                                <div>
                                  <Label htmlFor="drive_upload_file_name">File Name</Label>
                                  <Input
                                    id="drive_upload_file_name"
                                    type="text"
                                    ...
                                    onChange={(e) => {
                                      ...
                                      onNodeConfigChange(selectedNodeId, {
                                        ...nodeConfig,
                                        params: { ...currentParams, file_name: e.target.value }
                                      } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Name for the uploaded file (supports variables)</p>
                                </div>
                                <div>
                                  <Label htmlFor="drive_upload_file_content">File Content</Label>
                                  <textarea
                                    id="drive_upload_file_content"
                                    className="w-full p-2 border rounded mt-1 min-h-[100px]"
                                    placeholder="Content of the file (supports variables like {{gmail.body}})"
                                    value={(nodeConfig as ActionNodeData).params?.file_content as string || ''}
                                    onChange={(e) => {
                                      const currentParams = (nodeConfig as ActionNodeData).params || {};
                                      onNodeConfigChange(selectedNodeId, {
                                        ...nodeConfig,
                                        params: { ...currentParams, file_content: e.target.value }
                                      } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">File content (supports variables)</p>
                                </div>
                                <div>
                                  <Label htmlFor="drive_upload_folder_id">Folder ID (optional)</Label>
                                  <Input
                                    id="drive_upload_folder_id"
                                    type="text"
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Google Drive folder ID (optional)</p>
                                </div>
                                <div>
                                  <Label htmlFor="drive_upload_mime_type">MIME Type (optional)</Label>
                                  <Input
                                    id="drive_upload_mime_type"
                                    type="text"
                                    ...
                                    onChange={(e) => {
                                      ...
                                      onNodeConfigChange(selectedNodeId, {
                                        ...nodeConfig,
                                        params: { ...currentParams, mime_type: e.target.value }
                                      } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">MIME type (e.g., text/plain, application/pdf)</p>
                                </div>
                              </div>
                            )}
                            ...
                            {nodeConfig.serviceId === 'google_drive' && nodeConfig.actionId === 'create_folder' && (
                              <div className="space-y-3">
                                <div>
                                  <Label htmlFor="drive_create_folder_name">Folder Name</Label>
                                  <Input
                                    id="drive_create_folder_name"
                                    type="text"
                                    ...
                                    onChange={(e) => {
                                      ...
                                      onNodeConfigChange(selectedNodeId, {
                                        ...nodeConfig,
                                        params: { ...currentParams, folder_name: e.target.value }
                                      } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Name for the new folder (supports variables)</p>
                                </div>
                                <div>
                                  <Label htmlFor="drive_create_parent_folder_id">Parent Folder ID (optional)</Label>
                                  <Input
                                    id="drive_create_parent_folder_id"
                                    type="text"
                                    placeholder="Leave empty for root folder"
                                    ...
                                    onChange={(e) => {
                                      ...
                                      onNodeConfigChange(selectedNodeId, {
                                        ...nodeConfig,
                                        params: { ...currentParams, parent_folder_id: e.target.value }
                                      } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">Parent folder ID (leave empty to create in root)</p>
                                </div>
                              </div>
                            )}
                              ...
                              <div className="space-y-3">
                                <div>
                                  ...
                                  <Input
                                    ...
                                    type="text"
                                    placeholder="Google Drive file ID or {{drive.file_id}}"
                                    value={(nodeConfig as ActionNodeData).params?.file_id as string || ''}
                                    onChange={(e) => {
                                      const currentParams = (nodeConfig as ActionNodeData).params || {};
                                      onNodeConfigChange(selectedNodeId, {
                                        ...nodeConfig,
                                        params: { ...currentParams, file_id: e.target.value }
                                      } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">ID of the file to copy (supports variables)</p>
                                </div>
                                <div>
                                  <Label htmlFor="drive_copy_new_name">New Name (optional)</Label>
                                  <Input
                                    id="drive_copy_new_name"
                                    type="text"
                                    ...
                                    onChange={(e) => {
                                      ...
                                      onNodeConfigChange(selectedNodeId, {
                                        ...nodeConfig,
                                        params: { ...currentParams, new_name: e.target.value }
                                      } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">New name for the copied file (optional)</p>
                                </div>
                              </div>
                            )}
                              ...
                              <div className="space-y-3">
                                <div>
                                  ...
                                  <Input
                                    ...
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">ID of the file to move (supports variables)</p>
                                </div>
                                <div>
                                  <Label htmlFor="drive_move_destination_folder_id">Destination Folder ID</Label>
                                  <Input
                                    id="drive_move_destination_folder_id"
                                    type="text"
                                    placeholder="Google Drive folder ID"
                                    ...
                                    onChange={(e) => {
                                      ...
                                      onNodeConfigChange(selectedNodeId, {
                                        ...nodeConfig,
                                        params: { ...currentParams, destination_folder_id: e.target.value }
                                      } as ActionNodeData);
                                    }}
                                    onFocus={handleInputFocus}
                                  />
                                  <p className="text-xs text-gray-500 mt-1">ID of the destination folder (supports variables)</p>
                                </div>
                              </div>
                            )}
                            ...
                            {nodeConfig.serviceId === 'google_drive' && nodeConfig.actionId === 'delete_file' && (
                              <div>
                                ...
                                <Input
                                  ...
                                  onFocus={handleInputFocus}
                                />
                                <p className="text-xs text-gray-500 mt-1">ID of the file to delete/trash (supports variables)</p>
                              </div>
                            )}
