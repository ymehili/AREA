...
const providerConfig = {
  ...
  github: {
    name: "GitHub",
    bgColor: "bg-[#24292F] hover:bg-[#2F353D]",
  ...
  microsoft: {
    name: "Microsoft",
    bgColor: "bg-[#2F2F2F] hover:bg-[#3D3D3D]",
    textColor: "text-white",
    border: "",
    logo: (
...
export function OAuthButton({ provider, onClick, disabled, className, action = "signin" }: OAuthButtonProps) {
  ...
  return (
    <Button
      ...
      variant="outline"
      className={cn(
        "w-full flex items-center justify-center gap-3 font-medium transition-all duration-150",
        config.bgColor,
        config.textColor,
        config.border,
        className
